...
Log:=Edit1.Text;
Pass:=MaskEdit1.Text;
LogAndPass:=Edit1.Text+' '+MaskEdit1.Text;
for i := 0 to SaveTxt.Count-1 do
begin
  if LogAndPass = SaveTxt[i] then
  begin
    Form3.Show;
    Form4.Hide;
    ShowMessage('Данные введены корректно');
  end
  else
  begin
    Label3.Visible:=True;
    Label3.Caption:='Введите корректные данные';
    Edit1.Clear;
    MaskEdit1.Clear;
  end;
end;
