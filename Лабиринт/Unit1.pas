...
if LogAndPass<>'' then
begin
ShowMessage(Log+'.'+' Вы набрали очков: '+IntToStr(Knight.Score)+' Ваш уровень '+IntToStr(Knight.Level-1));
SaveTxt.Add(Log+' '+' Вы набрали очков: '+IntToStr(Knight.Score)+' Ваш уровень '+IntToStr(Knight.Level-1));
SaveTxt.SaveToFile(ExtractFilePath(Application.ExeName)+'RegEdit.txt');
end
else
begin
ShowMessage(LoginUsr+'.'+' Вы набрали очков: '+IntToStr(Knight.Score)+' Ваш уровень '+IntToStr(Knight.Level-1));
SaveTxt.Add(LoginUsr+' '+PassUsr+' Вы набрали очков: '+IntToStr(Knight.Score)+' Ваш уровень '+IntToStr(Knight.Level-1));
SaveTxt.SaveToFile(ExtractFilePath(Application.ExeName)+'RegEdit.txt')
end;
Form1.Close;
end;
